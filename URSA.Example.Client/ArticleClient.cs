...
namespace Vocab
{
    ...
    public partial class ArticleClient : Client
    {
        ...
        public System.Guid Create(Vocab.IArticle article)
        {
            ...
            var contentType = new string[] {
                ...
                "application/owl+xml",
                "text/turtle" };
            var result = System.Threading.Tasks.Task.Run(async () => await Call<System.Guid>(Verb.POST, "/api/article#POSTArticle", accept, contentType, uriArguments, article)).Result;
            return result;
        }
        ...
        public System.Collections.Generic.ICollection<Vocab.IArticle> List(out System.Int32 totalEntities, System.Int32 _skip, System.String _filter, System.Int32 _top)
        {
            System.Collections.Generic.IDictionary<string, object> uriArguments = new System.Collections.Generic.Dictionary<string, object>();
            var accept = new string[] {
                "application/owl+xml",
