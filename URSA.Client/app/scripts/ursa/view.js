...
(function(namespace) {
    ...
    var _SupportedPropertyRenderer = {
        initialize: function(scope, classNames) {
        ...
        renderField: function(scope, context) {
            var operation = null;
        ...
        renderCollection: function(scope, context, field) {
        ...
        setupPropertyScope: function(scope) {
            var that = this;
            ...
            scope.$on(Events.EntityLoaded, function(e, instance, type) { _SupportedPropertyRenderer.entityLoaded.call(that, scope, type); });
        ...
        entityLoaded: function(scope, type) {
            scope.supportedPropertyNewValues = {};
        ...
        entityEvent: function(scope, type) {
            scope.supportedPropertyNewValues = {};
            if (type.id === this.apiMember.owner.id) {
                _SupportedPropertyRenderer.loadItems.call(this, scope, type);
            }
        },
        isPropertyReadonly: function(scope, supportedPropertyId) {
        ...
        styleFor: function(scope, supportedPropertyId, index) {
        ...
        addPropertyItem: function(scope, supportedPropertyId) {
            var supportedProperty = scope.supportedProperties.getById(supportedPropertyId);
            var propertyName = supportedProperty.propertyName(scope.operation);
        ...
        removePropertyItem: function(scope, supportedPropertyId, index) {
            var supportedProperty = scope.supportedProperties.getById(supportedPropertyId);
            scope[scope.targetInstance][supportedProperty.propertyName(scope.operation)].splice(index, 1);
        },
        onIsNullCheckedChanged: function(scope, supportedPropertyId) {
            var supportedProperty = scope.supportedProperties.getById(supportedPropertyId);
            var propertyName = supportedProperty.propertyName(scope.operation);
            var instance = scope[scope.targetInstance];
            var value = instance[propertyName] || null;
        ...
        movePropertyItem: function(scope, supportedPropertyId, index, direction) {
            var supportedProperty = scope.supportedProperties.getById(supportedPropertyId);
            var propertyName = supportedProperty.propertyName(scope.operation);
            var isRdfList = ((scope.operation.isRdf) && (supportedProperty.range instanceof ursa.model.Class) && (supportedProperty.range.valueRange !== null));
        ...
        propertyInitialize: function(scope, supportedPropertyId) {
            var supportedProperty = scope.supportedProperties.getById(supportedPropertyId);
    ...
    var _OperationRenderer = {
        renderEntityList: function(scope, classNames) {
        ...
        onLoadEntitySuccess: function(scope, createOperation, instance, request, response) {
            var that = this;
            if ((response.headers("Content-Type") || "*/*").indexOf(ursa.model.EntityFormat.ApplicationLdJson) === 0) {
                that._jsonld.expand(response.data).
                    then(function(expanded) {
        ...
        loadEntity: function(scope, getOperation, instance) {
        ...
        createEntitySuccess: function(scope, createOperation, instance) {
        ...
        ammendEntityFailure: function(scope, createOperation, instance, request) {
        ...
        createEntity: function(scope, createOperation, instance) {
        ...
        onUpdateEntitySuccess: function(scope, updateOperation, instance) {
            scope.editedEntity = null;
            scope.$root.$broadcast(Events.EntityModified, instance, updateOperation.owner);
            scope.list();
        },
        updateEntity: function(scope, updateOperation, instance) {
        ...
        onDeleteEntitySuccess: function(scope, deleteOperation, instance) {
            scope.$root.$broadcast(Events.EntityRemoved, instance, deleteOperation);
            scope.list(1);
        },
        deleteEntity: function(scope, deleteOperation, instance, e) {
        ...
        onLoadEntityListSuccess: function(scope, deleteOperation, instance, request, response) {
            var that = this;
        ...
        loadEntityList: function(scope, listOperation, instance, page) {
        ...
        entityEquals: function(leftOperand, rightOperand, operation) {
        ...
        findEntityListMethod: function(listOperation) {
        ...
        sanitizeEntity: function(instance, operation) {
            if (!operation.isRdf) {
                return instance;
            }
        ...
        initialize: function(scope, index) {
            if (index === -1) {
        ...
        isFormDisabled: function(scope, name) {
        ...
        handleUnauthorized: function(scope, challenge, callback) {
        ...
        handleAuthorized: function(scope) {
            if (this._authenticationEventHandler) {
                this._authenticationEventHandler();
                delete this._authenticationEventHandler;
            }
        ...
        prepareRequest: function(operation, methodOverride, instance) {
            var request = {
        ...
        handleOperation: function(scope, operation, methodOverride, instance, success, failure, callbackMethod, context) {
            var that = this;
