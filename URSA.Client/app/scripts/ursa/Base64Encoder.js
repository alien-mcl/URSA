...
(function(namespace) {
    ...
    /**
     * Base64 encoding facility.
     * @memberof ursa
     * @name Base64Encoder
     * @public
     * @class
     * @extends {ursa.Encoder}
     */
    var Base64Encoder = (namespace.Base64Encoder = function() {})[":"](ursa.Encoder);

    Base64Encoder.prototype.encode = function(input) {
        ursa.Encoder.prototype.encode.apply(this, arguments);
        var output = "";
        var chr1, chr2, chr3;
    ...
    Base64Encoder.prototype.decode = function (input) {
        ursa.Encoder.prototype.decode.apply(this, arguments);
